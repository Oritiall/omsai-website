#!/usr/bin/env python3
"""skill-scout CLI. The SKILL.md agent calls these; output is JSON it presents in Hebrew.
...
from skillscout import install as inst   # noqa: E402
from skillscout import vet as vetmod      # noqa: E402
from skillscout.common import relevance   # noqa: E402
from skillscout.score import score_candidate, band_label  # noqa: E402
from skillscout.sources import CONNECTORS  # noqa: E402
